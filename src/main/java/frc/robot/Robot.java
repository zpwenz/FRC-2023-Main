...
public class Robot extends TimedRobot {
   ...
   */
  WPI_VictorSPX driveLeftFrontVictor = new WPI_VictorSPX(1);
  WPI_VictorSPX driveRightFrontVictor = new WPI_VictorSPX(2);
  Spark driveRightBackSpark = new Spark(1);
  Spark driveLeftBackSpark = new Spark(0);
  MotorControllerGroup driveLeft = new MotorControllerGroup(driveLeftBackSpark, driveLeftFrontVictor);
  MotorControllerGroup driveRight = new MotorControllerGroup(driveRightBackSpark, driveRightFrontVictor);
  ...
  public void robotInit() {
     ...
     */
    driveLeftBackSpark.setInverted(false);
    driveLeftFrontVictor.setInverted(false);
    driveRightBackSpark.setInverted(false);
  ...
  public void setDriveMotors(double forward, double turn) {
    ...
    // directions.
    driveLeftBackSpark.set(left);
    driveLeftFrontVictor.set(ControlMode.PercentOutput, left);
    driveRightBackSpark.set(right);
  ...
  public void autonomousPeriodic() {
    ...
    SmartDashboard.putNumber("X-Axis Acceleration", m_gyro.getAccelX());
    SmartDashboard.putNumber("X-Axis Angle", m_gyro.getYComplementaryAngle());
    if (m_gyro.getYComplementaryAngle() > 1.5) {
      driveLeftBackSpark.set(.2);
      driveRightBackSpark.set(.2);
      driveLeftFrontVictor.set(.2);
      driveRightFrontVictor.set(.2);
  ...
  public void teleopPeriodic() {
    ...
    if (m_gyro.getYComplementaryAngle() > 1.5) {
      driveLeftBackSpark.set(-.2);
      driveRightBackSpark.set(.24);
      driveLeftFrontVictor.set(-.2);
      driveRightFrontVictor.set(.24);}
    else if (m_gyro.getYComplementaryAngle() < -1.5) {
      driveLeftBackSpark.set(.2);
      driveRightBackSpark.set(-.24);
      driveLeftFrontVictor.set(.2);
      driveRightFrontVictor.set(-.24);
    ...
    m_drive.curvatureDrive(XboxController.getRightX(), -XboxController.getLeftY(), true);
  }
}
